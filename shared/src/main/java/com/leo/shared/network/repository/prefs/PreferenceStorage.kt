...
package com.leo.shared.network.repository.prefs
...
class SharedPreferenceStorage @Inject constructor(context: Context) :
    ...
    override var profileImage by StringPreference(
        prefs,
        PROFILE_IMAGE,
        ""
    )

    override var sound by BooleanPreference(
        prefs,
        SOUND,
        true
    )
    ...
    override var appBundle by StringPreference(
        prefs,
        PREF_APP_BUNDLE,
        ""
    )

    override var locale by StringPreference(
        prefs,
        PREF_LOCALE,
        ""
    )

    override var login by StringPreference(
        prefs,
        PREF_LOGIN,
        ""
    )

    override var password by StringPreference(
        prefs,
        PREF_PASSWORD,
        ""
    )
    ...
    override var isTouchIdEnabled by BooleanPreference(
        prefs,
        PREF_TOUCH_ID,
        false
    )
